...
| `doom` | **DOOM real, jugable** — [doomgeneric](https://github.com/ozkl/doomgeneric) + puerto propio sobre `FBIO_BLIT` (`/dev/fb`) y `/dev/input/event0` (evdev real), IWAD Freedoom leído de `/mnt/freedoom1.wad` (ext2). Ver la entrada de arriba |
...
│   │   ├── drivers/      # /dev/null, /dev/zero, /dev/console, /dev/fb, /dev/kbd, /dev/input/event0 (evdev)
